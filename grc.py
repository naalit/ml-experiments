...
class GRC_Self_Attention(nn.Module):
    ...
    def forward(self, x,  **kwargs):
        ...
        x_self = self.attn_self_func(x, key=x, value=x, **kwargs)[0].view(B, T, self.heads, -1) # kv=x
        ...
        x_mem = self.attn_mem(x[:, :, :self.cache_dim], key=gr_cache_value, value=gr_cache_value)[0].view(B, T, self.heads, -1)
